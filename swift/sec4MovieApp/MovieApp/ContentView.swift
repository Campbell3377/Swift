...
struct ContentView: View {
    @StateObject var movieInfoDictionary:infoDictionary = infoDictionary()
    ...
    var body: some View {
        NavigationView{
            VStack {
                Spacer()
                NaviView(titleN: $title, genreN:$genre, priceN:$price, deleteTitle: $deleteS, pModel: movieInfoDictionary,
                         listN: $list)
                ...
                SearchView(titleS: $searchTitle, genreS: $searchGenre, priceS: $searchPrice,
                           messageS: $message)
                Spacer()
                ToolView(searchTitle: $searchTitle, editTitle: "", editGenre: "", editPrice: "", sGenre: $searchGenre , sPrice: $searchPrice, pModel: movieInfoDictionary, sList: $list, sIndex: $listIndex, sMessage: $message)
